...
fn main() {
	...
	Command::new("C:/Program Files/Microsoft Office/root/Office16/EXCEL.EXE")
        .spawn()
        .expect("Nie można uruchomić Excel");
		
	// 2. Daj Excelowi czas na start
